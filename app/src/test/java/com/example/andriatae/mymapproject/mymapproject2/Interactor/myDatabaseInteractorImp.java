...
public class myDatabaseInteractorImp implements com.example.andriatae.mymapproject.Interactor.myDatabaseInteractor {
    Realm realm;
    ...
    public void getCarParkInRealm(final List<CarPark> myCarPark) {
        ...
        System.out.println("inside databse method");
        realm = null;
        try {
            realm = Realm.getDefaultInstance();
