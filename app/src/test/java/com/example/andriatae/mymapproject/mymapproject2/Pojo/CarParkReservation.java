package com.example.andriatae.mymapproject.mymapproject2.Pojo;
...
public class CarParkReservation {
    ...
    public String toString() {
        ...
        return new ToStringBuilder(this).append("lat", lat).append("lng", lng).append("name", name).append("costPerMinute", costPerMinute).append("maxReserveTimeMins", maxReserveTimeMins).append("minReserveTimeMins", minReserveTimeMins).append("isReserved", isReserved).append("reservedUntil", reservedUntil).toString();
